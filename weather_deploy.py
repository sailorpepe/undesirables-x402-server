...
def main():
    ...
    print(f"  Balance: {bal} zkLTC")
    if bal == 0:
        print("  ERROR: No zkLTC for gas")
        sys.exit(1)
    ...
    deploy_info = {
        ...
        "explorer": f"https://liteforge.explorer.caldera.xyz/address/{addr}",
    }
    deploy_path = os.path.join(SCRIPT_DIR, "weather_deployment.json")
