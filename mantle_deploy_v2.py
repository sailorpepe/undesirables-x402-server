...
def deploy():
    ...
    BATCH_SIZE = 25
    # Fetch latest nonce after deployment
    time.sleep(2) # Give the RPC a moment to index
    nonce = w3.eth.get_transaction_count(wallet)
    ...
    result_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "mantle_v2_deployment.json")
